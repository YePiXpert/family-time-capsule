export const MODEL_ID = 'mimo-v2.6-flash' as const;
...
export const LEGACY_MODEL_IDS = [MODEL_ID, 'mimo-v2.5', 'deepseek-flash', 'gpt-5.6-luna', 'gpt-5.6-sol', 'gpt-6-astra'] as const;
