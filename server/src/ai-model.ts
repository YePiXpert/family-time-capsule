export const MODEL_ID = 'mimo-v2.5' as const;
export const MODEL_LABEL = 'MiMo 2.5';
...
export const LEGACY_MODEL_IDS = [MODEL_ID, 'deepseek-flash', 'gpt-5.6-luna', 'gpt-5.6-sol', 'gpt-6-astra'] as const;
