...
// 57.0.20 (like 57.0.19) retains the same unguarded UIKit camera setup verbatim; the exact
// source check below remains mandatory before applying this patch.
if (picker.version !== "57.0.20") {
