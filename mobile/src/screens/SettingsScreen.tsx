...
const styles = StyleSheet.create({
  ...
  smallAction: { borderColor: colors.sage, borderRadius: 10, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 8 },
  smallActionDanger: { borderColor: "#D9AAA1", borderRadius: 10, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 8 },
