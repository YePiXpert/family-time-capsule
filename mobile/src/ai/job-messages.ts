const MESSAGES: Record<string, string> = {
  capability_unavailable: "这一步所需的模型尚未配置，请查看 AI 设置。",
  capability_not_consented: "请先由管理员在 AI 设置中同意这项外部处理。",
  source_forbidden_or_not_found: "素材已移除或权限发生变化，本次没有发送。",
  inbox_item_closed: "素材已确认入档，请在对应记忆中整理。",
  not_retryable: "任务状态已变化，请刷新后再操作。",
  organizer_context_limit: "这件记忆包含太多来源，请缩小整理范围。",
