...
主人指定文字模型为 **GPT-6 Astra medium**（`gpt-6-astra`），专用转写为 `mimo-v2.5-asr`，两者共用主人提供的兼容上游与密钥。**已于 2026-09-24 15:21 UTC 部署**，源码 `5eee8556c95b72b063b1381b9fc43a6b0b59acc2`。隔离 staging 的五种文字任务、ASR 与家庭／备份流程通过；生产本机及公网健康版本一致，家庭、成员、设备与额度核对通过。详见 HANDOFF 第一节。
