...
export default async function PendingPage() {
  ...
  const data = await getHomeDashboard(context);
  return <main className="page-container">
    ...
    <div className="mt-5 space-y-3">
      ...
      <PendingDrafts scope={`${context.userId}:${context.familyId}`} otherwiseEmpty={!data.inbox.count && !data.pendingImports.length} />
    </div>
  </main>;
}
