...
状态：v1.2.0-alpha.1 prerelease 已发布；完整 CI、原生包与附件 SHA 校验通过。基线 `99ac692ec7bd5c91ca499d3c71cd6cedf4afcd10`；不替换已发布 1.1。
...
| M8 恢复/发布 | 完整门禁、原生构建及 prerelease 发布完成 | 独立目录/卷升级、旧档恢复、二次导出、失败回滚 |
...
M8 已用 1.1 tag 的真实旧导出/数据库完成独立目录与 Docker 卷升级和恢复；1.2 灾难测试
销毁源目录，恢复九个新增编辑模块并二次导出逐项一致。最终 CI/标签/原生附件结果见发布记录。

已发布 [v1.2.0-alpha.1](https://github.com/YePiXpert/family-time-capsule/releases/tag/v1.2.0-alpha.1)。
发布 SHA `7be689c`：main CI `33947248450`、原生 run `33947701020` 全绿；APK/unsigned IPA
与 SHA256SUMS 下载校验通过，详细包级结果和未验收真机项目见 RELEASE_1_2。
