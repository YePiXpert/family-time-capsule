...
> **历史记录**：2026-09-21 批准并实施的「说一段」，随 1.0.0 发布。安卓的逐段同意已在 1.1.1 取消；现行转写配置见部署指南。正文保留当时的状态、命令与待办，不代表现在。当前范围见 [PRODUCT](../../../PRODUCT.md)，交付状态见 [HANDOFF](../../../HANDOFF.md)，全部历史文档见 [索引](../README.md)。
