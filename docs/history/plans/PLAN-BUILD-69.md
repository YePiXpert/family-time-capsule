...
> **历史记录**：2026-09-19 批准、09-20 实施完毕的 Build 69 界面整顿。系列、足迹、重放已在 1.0.3 撤回，AI 设置页已在 1.1.1 取消。正文保留当时的状态、命令与待办，不代表现在。当前范围见 [PRODUCT](../../../PRODUCT.md)，交付状态见 [HANDOFF](../../../HANDOFF.md)，全部历史文档见 [索引](../README.md)。

## Context

- **前提**：service.example.invalid 的服务端已按 `deploy/README.md` 部署到 main 最新（含 scrypt2 哈希升级），HANDOFF 里唯一挂着的「服务端尚未部署」已闭环。上一次 main CI（9bd192a）全绿，工作区干净。
- **主人拍板（2026-09-19）**：
