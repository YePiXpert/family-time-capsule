...
> **历史记录**：Build 70 本机 blob 库、分卷与加密远端备份，已交付。每位成员各一份远端的模型已被 Build 72 的家庭共享取代，再被 1.1.0 的设备授权取代。正文保留当时的状态、命令与待办，不代表现在。当前范围见 [PRODUCT](../../../PRODUCT.md)，交付状态见 [HANDOFF](../../../HANDOFF.md)，全部历史文档见 [索引](../README.md)。
