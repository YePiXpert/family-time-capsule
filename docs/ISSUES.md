...
- [x] M1 统一 Collection：Web/原生整理阅读、浅层章节、排序/说明/删除恢复与月份草稿。
- [x] M2 家庭时区日历、年龄定位、一致过滤与稳定分页；日期变更同步。
- [x] M3 Web/原生媒体阅读、人物声音、主动播放器与非 AI 有界衍生物。
- [x] M4 BookProject 三模板、选材编辑、自动保存、冲突保留、来源与版本完整恢复。
- [x] M5 可搜索中文 PDF、EPUBCheck、独立有界任务、读者与来源实时检查。
