...
> 最后更新：2026-09-24。**main 上有一批未打包的改动：首页一屏放下与编辑页一张纸**（`7ab85f7`／`24068f5`／`dec20b5`／`d35b2c1`，CHANGELOG 顶节「未打包 — 首页一屏放下与编辑页一张纸」；门禁全绿）。首页的复验 [run 35870739215](https://github.com/YePiXpert/family-time-capsule/actions/runs/35870739215)（源码 `dec20b5`）一次全绿、首页截图正常（第一节第二条）。主人 2026-09-24 说「新增的时候，下面导航栏挺好的，看的，但是整个页面就很丑」，`d35b2c1` 把编辑页改成一张纸，验证出包见第一节第一条。可安装的是 1.0.4（下一条）。
