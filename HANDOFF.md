...
- **1.0.5 发版（2026-09-24，构建号 78）**：主人说「发包吧」。发版提交与标签 `v1.0.5` 的出包 run、八个作业结果、Release 资产与校验和、`build-source.json` 与 IPA plist 的源提交／版本核对，完成后补在这里。
