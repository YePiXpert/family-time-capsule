...
当前安装包：[1.1.2 · 构建号 84](https://github.com/YePiXpert/family-time-capsule/releases/tag/v1.1.2)。

- [Android APK](https://github.com/YePiXpert/family-time-capsule/releases/download/v1.1.2/FamilyTimeCapsule-android.apk)
- [iOS IPA（未签名，需自行签名）](https://github.com/YePiXpert/family-time-capsule/releases/download/v1.1.2/FamilyTimeCapsule-ios-unsigned.ipa)
- [SHA-256 校验和](https://github.com/YePiXpert/family-time-capsule/releases/download/v1.1.2/sha256sums.txt)
